...
<section id="services" class="d4w-services section-space">
	<div class="container-fluid d4w-shell">
		<div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4">
			<div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-heading-visual--dark d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'services_section_image', 'service-web-design.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Website design and creative strategy', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label d4w-section-label--light reveal-up"><span>02</span><?php esc_html_e( 'What we do', 'design4web' ); ?></p></div>
...
<section id="products" class="d4w-home-products section-space-sm">
	<div class="container-fluid d4w-shell">
		<div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4"><div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'products_section_image', 'service-marketing.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Digital product and messaging solutions', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label reveal-up"><span>Products</span><?php esc_html_e( 'WhatsApp growth stack', 'design4web' ); ?></p></div><div class="col-lg-6"><h2 class="d4w-display reveal-text"><?php echo esc_html( d4w_get_option( 'products_title' ) ); ?></h2></div><div class="col-lg-2 text-lg-end"><a class="d4w-text-link reveal-up" href="<?php echo esc_url( get_post_type_archive_link( 'd4w_product' ) ); ?>"><?php esc_html_e( 'All products', 'design4web' ); ?><i class="bi bi-arrow-right"></i></a></div></div>
...
<?php if ( d4w_get_option( 'show_projects', true ) ) : ?>
	<section id="work" class="d4w-work d4w-clients-archive d4w-home-work section-space">
		<div class="container-fluid d4w-shell">
			<div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4">
				<div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-heading-visual--dark d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'work_section_image', 'clients/dreamdrip-by-seh.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Selected website design work', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label d4w-section-label--light reveal-up"><span>Work</span><?php esc_html_e( 'Our work', 'design4web' ); ?></p></div>
...
<section id="case-studies" class="d4w-home-cases section-space-sm">
	<div class="container-fluid d4w-shell"><div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4"><div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-heading-visual--dark d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'case_section_image', 'project-2.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Selected digital case study', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label d4w-section-label--light reveal-up"><span>Cases</span><?php esc_html_e( 'Case studies', 'design4web' ); ?></p></div><div class="col-lg-6"><h2 class="d4w-display text-white reveal-text"><?php echo esc_html( d4w_get_option( 'case_studies_title' ) ); ?></h2></div><div class="col-lg-2 text-lg-end"><a class="d4w-text-link d4w-text-link--light reveal-up" href="<?php echo esc_url( get_post_type_archive_link( 'd4w_project' ) ); ?>"><?php esc_html_e( 'Read all cases', 'design4web' ); ?><i class="bi bi-arrow-right"></i></a></div></div><div class="d4w-case-strip">
...
<section id="insights" class="d4w-insights section-space-sm">
	<div class="container-fluid d4w-shell">
		<div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4">
			<div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'insights_section_image', 'service-development.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Digital strategy insights', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label reveal-up"><span>06</span><?php esc_html_e( 'Ideas & insights', 'design4web' ); ?></p></div>
...
<section class="d4w-social-feed section-space-sm"><div class="container-fluid d4w-shell"><div class="row d4w-visual-heading-row align-items-stretch mb-5 g-4"><div class="col-lg-4 d4w-section-heading-side"><figure class="d4w-heading-visual d4w-image-curtain reveal-up"><img src="<?php echo esc_url( d4w_option_image_url( 'social_section_image', 'service-hosting.jpg' ) ); ?>" alt="<?php esc_attr_e( 'Design4web studio and social content', 'design4web' ); ?>" loading="lazy"></figure><p class="d4w-section-label reveal-up"><span>Social</span><?php esc_html_e( 'Studio & Instagram feed', 'design4web' ); ?></p></div><div class="col-lg-6"><h2 class="d4w-display reveal-text"><?php echo esc_html( d4w_get_option( 'social_title' ) ); ?></h2></div><div class="col-lg-2 text-lg-end"><?php if ( d4w_get_option( 'instagram_url' ) ) : ?><a class="d4w-text-link reveal-up" href="<?php echo esc_url( d4w_get_option( 'instagram_url' ) ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Follow Instagram', 'design4web' ); ?><i class="bi bi-instagram"></i></a><?php endif; ?></div></div><div class="d4w-social-grid">
